...
namespace Sistema_De_Citas_Medicas.Controllers
{
    public class MedicosController : Controller
    {
        ...
        {
            ViewData["UsuarioId"] = new SelectList(_context.Set<Usuario>(), "Id", "Contraseña");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Especialidad,Consultorio,UsuarioId")] Medico medico)
        {
            ...
            ViewData["UsuarioId"] = new SelectList(_context.Set<Usuario>(), "Id", "Contraseña", medico.UsuarioId);
            return View(medico);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Especialidad,Consultorio,UsuarioId")] Medico medico)
        {
            if (id != medico.Id)
            {
                return NotFound();
