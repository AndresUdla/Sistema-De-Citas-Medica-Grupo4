...
namespace Sistema_De_Citas_Medicas.Controllers
{
    public class PacientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Direccion,Telefono,UsuarioId")] Paciente paciente)
        {
            ...
            ViewData["UsuarioId"] = new SelectList(_context.Set<Usuario>(), "Id", "Contraseña", paciente.UsuarioId);
            return View(paciente);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Direccion,Telefono,UsuarioId")] Paciente paciente)
        {
            if (id != paciente.Id)
            {
                return NotFound();
